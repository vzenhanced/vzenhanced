...
#define ST_Enable_SSL_TLS_					server_string_table[ 5 ]
#define ST_Enable_web_server_				server_string_table[ 6 ]
#define ST_Hostname_						server_string_table[ 7 ]
#define ST_IP_address_						server_string_table[ 8 ]
...
#define ST_Public_Private_key_pair_			server_string_table[ 18 ]
...
#define ST_SSL_TLS_version_					server_string_table[ 24 ]
